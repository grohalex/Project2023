...
class Gcode:
    ...
    def startGcode(self,*, extruder_temp=0, bed_temp=0):
        with open('/Users/macbookpro/Desktop/SciSlice-master/Start_End_Gcode/Start_Gcode.txt') as startFile:###
    ...
    def endGcode(self):
        with open('/Users/macbookpro/Desktop/SciSlice-master/Start_End_Gcode/End_Gcode.txt') as endFile:
...
class RobotCode:
    ...
    def startGcode(self,*, extruder_temp=0, bed_temp=0):
        print('hhhhere')###
        print(self.pr.start_Gcode_FileName)###
        # with open(self.pr.startEndSubDirectory + '/' + self.pr.start_Gcode_FileName) as startFile:
        with open('/Users/macbookpro/Desktop/SciSlice-master/Start_End_Gcode/Start_Gcode.txt') as startFile:###
            lines = startFile.readlines()   
            tempString = []
    ...
    def endGcode(self):
        with open('/Users/macbookpro/Desktop/SciSlice-master/Start_End_Gcode/Start_Gcode.txt') as endFile:        
