...
class Gcode:
    ...
    def feedMove(self, endPoint, extrudeTo, printSpeed):
        ...
        return 'G1 ' + tempString + ' F{:.0f}\n'.format(printSpeed)

    def rapidMove(self, endPoint, atClearance=False):
        return ('G0 X{:.3f} Y{:.3f} Z{:.3f} F{:.0f}\n'.format(endPoint.x,
                                                                endPoint.y,
    ...
    def startGcode(self,*, extruder_temp=0, bed_temp=0):
        with open('/Users/macbookpro/Desktop/Project2023/SciSlice-master/Start_End_Gcode/Start_Gcode.txt') as startFile:###
    ...
    def endGcode(self):
        with open('/Users/macbookpro/Desktop/Project2023/SciSlice-master/Start_End_Gcode/End_Gcode.txt') as endFile:
...
class RobotCode:
    ...
    def endGcode(self):
        with open('/Users/macbookpro/Desktop/Project2023/SciSlice-master/Start_End_Gcode/Start_Gcode.txt') as endFile:
